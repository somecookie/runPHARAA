...
public class FilterPropertiesTest {
    ...
    public void chooseLuckyTrackTest(){
        ...
        Track t1 = new Track("t1", "t1UDI", "t1Creator", path, tp1);
        Track t2 = new Track("t2", "t2UDI", "t2Creator", path, tp2);
